...
For frontend-only development, run Vite instead:
...
This starts the frontend on port 5173 and proxies `/api` requests to the backend on port 8000.
...
- Charts: Canvas elements rendered with Chart.js 4 line charts; no jQuery or Bootstrap CDN assets are used
- Refresh Data button triggers data reload
- Theme toggle switches between light and dark modes and persists the selection
...
- Frontend: React + Vite + TypeScript with Chart.js 4
